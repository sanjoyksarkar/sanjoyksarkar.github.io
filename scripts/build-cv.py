...
doc=SimpleDocTemplate('tmp/generated-CV.pdf',pagesize=(595.28,841.89),rightMargin=44,leftMargin=44,topMargin=38,bottomMargin=49,title=p['name']+' | '+p['title'],author=p['name'])
doc.build(story,onFirstPage=footer,onLaterPages=footer)
print('Built optional draft tmp/generated-CV.pdf; the approved public CV is unchanged.')
